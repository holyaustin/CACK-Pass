...
export const contractAbi = [
  // Paste your full ABI here (from Hardhat/Solidity compile)
  // Or import via @sourcify/verify or export from contract
    {
      "inputs": [],
