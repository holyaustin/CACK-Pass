...
export default function Footer() {
  return (
    <footer className="bg-black/80 text-white py-10 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <Link href="/" className="flex justify-center items-center space-x-3 mb-4">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-orange-500 flex items-center justify-center">
